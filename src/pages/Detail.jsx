      ...
      <div className="container">
        <div className="detailimage">
          <img
            ...
            src="https://cdn.wadiz.kr/wwwwadiz/green001/2023/0426/20230426135706803_202224.jpg/wadiz/resizecrop/600x315/composite/ne/format/jpg/quality/80"
          />
        </div>
        <div className="detailsummary">
          ...
          <div>펀딩금액: </div>
          title: "역대급 함유량", // category: "홈, 리빙", // totalAmount:
          100000, // targetAmount: 50000, // deadLine: new Date(), //
          percentage: 200, // name: "화장품", // projectImage: "프로젝트이미지가
          뭘까?", // imageUrl: "어떤 형태가 되어야 하지? 주소 썼더니 에러뜨네",
          // summary : “아주 좋은 화장품”, // storyBoard : "이 제품은요. 아주
          좋아요”, // ikesStaus: false, // likes: 5{/*  */}
          <div></div>
          {/*  */}
          <div></div>
          {/*  */}
